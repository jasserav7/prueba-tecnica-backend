...
```bash
# Terminal 1 – Auth
cd backend/auth-service && uvicorn main:app --port 8000 --reload

# Terminal 2 – Catalog
cd backend/catalog-service && uvicorn main:app --port 8001 --reload

# Terminal 3 – Cart
cd backend/cart-service && uvicorn main:app --port 8002 --reload

# Terminal 4 – Orders
cd backend/orders-service && uvicorn main:app --port 8003 --reload
```
...
cd backend/catalog-service && pytest tests/ -v
cd backend/cart-service    && pytest tests/ -v
cd backend/orders-service  && pytest tests/ -v
```
